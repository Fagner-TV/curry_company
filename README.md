...
2. Premissas assumidas para a análise:
  ...
  a. A análise foi realizada com dados entre 11/02/2022 e 06/04/2022.
  
  b. Marketplace foi o modelo de negócio assumido.
  
  c. Os 3 principais visões do negócio foram: Visão transação de pedidos, visão restaurante e visão entregadores.
...
O painel pode ser acessado através desse link: https://ftv-curry-company.streamlit.app/
